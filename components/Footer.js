...
export default function Footer() {
  return (
    <footer className="text-gray-900 bg-slate-500">
	<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:divide-gray-600">
		<ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start text-white font-medium">
			<li>About</li>
			<li>Pricing</li>
			<li>Contact</li>
		</ul>
